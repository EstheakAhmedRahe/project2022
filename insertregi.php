...
$duplicate_username= mysqli_query($conn,"SELECT * FROM `regi` WHERE username='$userName'");
$duplicate_mobile= mysqli_query($conn,"SELECT * FROM `regi` WHERE mobile='$mobile'");
$duplicate_email= mysqli_query($conn,"SELECT * FROM `regi` WHERE email='$email'");
...
if(mysqli_num_rows(
  ...
  $inserQuery="INSERT INTO `regi`( `username`, `password`, `email`, `mobile`) VALUES ('$userName','$passworld','$email','$mobile')";
